...
DDEESSCCRRIIPPTTIIOONN
       List information about the FILEs (the current directory by default).  Sort entries alphabetically if none of --ccffttuuvvSSUUXX nor ----ssoorrtt is specified.
       ...
       --cc     with --lltt: sort by, and show, ctime (time of last modification of file status information); with --ll: show ctime and sort by name; otherwise: sort by ctime, newest first
       ...
       ----iinnddiiccaattoorr--ssttyyllee=_W_O_R_D
              append indicator with style WORD to entry names: none (default), slash (--pp), file-type (----ffiillee--ttyyppee), classify (--FF)
       ...
       ----ttiimmee=_W_O_R_D
              change the default of using modification times; access time (--uu): atime, access, use; change time (--cc): ctime, status; birth time: birth, creation;
       ...
       --uu     with --lltt: sort by, and show, access time; with --ll: show access time and sort by name; otherwise: sort by access time, newest first
       ...
       Using  color to distinguish file types is disabled both by default and with ----ccoolloorr=_n_e_v_e_r.  With ----ccoolloorr=_a_u_t_o, ls emits color codes only when standard output is connected to a terminal.  The LS_COL‐
